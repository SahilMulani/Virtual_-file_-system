...
void man(char *name)
{
	...
	{
		printf("Description : Used to write data into new regular file\n");
...
void DisplayHelp()
{
	...
	printf("read : to read contents from opened file\n");
	...
	printf("rm : To to delete the file\n");
}
...
int LseekFile(int fd,int size,int from)
{
	...
	if((UFDTArr[fd].ptrfiletable->mode == READ) || (UFDTArr[fd].ptrfiletable->mode == READ+WRITE))
	{
		...
		return (UFDTArr[fd].ptrfiletable->readoffset);
	}
	...
	else if(UFDTArr[fd].ptrfiletable->mode == WRITE)
	{
		...
		return (UFDTArr[fd].ptrfiletable->writeoffset);
	}
}
